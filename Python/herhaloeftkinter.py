...
def quizstart(aantalkeer):
    global score
    global max_score
    if aantalkeer > 0:
        vraag.config(text = str(vragen[aantalkeer]))
        entry.bind("<Return>", antwoord(aantalkeer))
...
aantalvragen = 2
b1 = Button(root, text="gooi hond", font="times 20 bold", command=antwoord)
b1.place(x=25,y=250)
